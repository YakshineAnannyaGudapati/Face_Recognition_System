...
db_path = r"C:/Users/HP/Downloads/Out"
...
class App:
    ...
    def accept_register_new_user(self):
        ...
        # Save image to db_path
        img_path = os.path.join(db_path, name + '.jpg')
        cv2.imwrite(img_path, self.register_new_user_capture)

        # Save name to txt file
        names_path = os.path.join(db_path, 'names.txt')
        with open(names_path, 'a') as f:
            f.write(name + '\n')
        print("11111111111111111", name, "12345ty")
        # Save embeddings to pickle file
        embeddings_path = os.path.join(db_path, '{}.pickle'.format(name))
        print(self.register_new_user_capture, "1234567890-=-0987654321234567890-")
